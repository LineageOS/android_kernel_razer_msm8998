...
#define E2P_PARTITION		"/dev/block/platform/soc/1da4000.ufshc/by-name/deviceinfo"
...
#define E2P_FACTORY_DATA_INFO_OFFSET	((512)*(1024))
...
#define E2P_FACTORY_DATA_SIZE		(((512)*(1024)) - (E2P_FACTORY_DATA_INFO_SIZE))
