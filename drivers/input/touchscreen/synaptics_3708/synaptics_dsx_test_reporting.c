...
#define  CFG_F54_TXCOUNT    26           // Number of Transmitters on device under test
#define  CFG_F54_RXCOUNT    14           // Number of Receivers    on device under test
#define  RESULT_SIZE    15100


static short GISFullRawCapUpperLimit[CFG_F54_TXCOUNT][CFG_F54_RXCOUNT] =
{
    {4121,4087,4087,4086,4086,4066,4060,4060,4070,4042,4029,4018,4025,4065},
    {4092,4085,4086,4082,4087,4068,4059,4057,4047,4035,4022,4009,4013,4017},
    {4091,4085,4087,4086,4092,4072,4061,4061,4052,4042,4025,4014,4014,4017},
    {4118,4113,4120,4115,4118,4102,4091,4091,4081,4070,4053,4043,4044,4046},
    {4098,4092,4095,4099,4113,4081,4070,4070,4060,4046,4034,4024,4029,4027},
    {4129,4148,4125,4122,4128,4111,4100,4099,4089,4079,4065,4053,4056,4057},
    {4141,4133,4163,4133,4138,4124,4112,4112,4103,4094,4078,4068,4070,4070},
    {4137,4133,4135,4134,4164,4147,4113,4112,4103,4092,4076,4064,4068,4069},
    {4159,4155,4157,4180,4160,4143,4134,4134,4125,4112,4099,4089,4092,4091},
    {4131,4135,4138,4135,4146,4125,4143,4117,4108,4103,4085,4076,4078,4069},
    {4173,4181,4180,4178,4186,4169,4160,4160,4154,4144,4130,4121,4126,4117},
    {4173,4173,4174,4196,4394,4164,4155,4185,4146,4138,4122,4116,4118,4112},
    {4243,4222,4222,4216,4221,4203,4195,4199,4191,4187,4174,4169,4177,4196},
    {4200,4194,4206,4207,4220,4215,4219,4230,4233,4237,4239,4242,4273,4291},
    {4160,4165,4178,4181,4196,4187,4187,4195,4196,4196,4194,4195,4209,4215},
    {4193,4207,4217,4219,4235,4225,4228,4234,4235,4239,4239,4239,4251,4255},
    {4186,4198,4207,4207,4222,4212,4215,4222,4225,4228,4230,4232,4246,4246},
    {4242,4251,4260,4263,4274,4264,4267,4274,4277,4277,4280,4281,4294,4300},
    {4255,4263,4271,4268,4281,4273,4274,4281,4284,4287,4286,4286,4302,4334},
    {4260,4268,4276,4274,4286,4278,4281,4290,4291,4294,4298,4299,4315,4323},
    {4313,4330,4339,4338,4349,4339,4341,4349,4351,4351,4354,4356,4398,4372},
    {4303,4326,4330,4328,4341,4332,4332,4337,4342,4342,4347,4347,4362,4360},
    {4347,4363,4373,4368,4380,4365,4369,4377,4381,4381,4386,4388,4438,4411},
    {4362,4378,4384,4378,4388,4378,4384,4390,4402,4393,4398,4398,4446,4440},
    {4408,4417,4425,4423,4432,4423,4428,4434,4437,4433,4466,4441,4458,4451},
    {4536,4488,4488,4480,4475,4456,4473,4494,4507,4507,4518,4559,4564,4633},

};


static short GISFullRawCapLowerLimit[CFG_F54_TXCOUNT][CFG_F54_RXCOUNT] =
{
    {2219,2201,2201,2200,2200,2190,2186,2186,2192,2176,2169,2164,2167,2189},
    char *TouchRawArray = NULL;
    ssize_t raw_pos = 0;

#endif

    pr_debug("F@TOUCH %s ENTER\n", __func__);
    ...
    numberOfColums = f54->tx_assigned;
    numberOfRows = f54->rx_assigned;


    pr_info("F@TOUCH %s numberOfColums TX(%d) numberOfRows RX(%d)\n", __func__, numberOfColums, numberOfRows);

    if((numberOfColums > CFG_F54_TXCOUNT) ||
            (numberOfRows > CFG_F54_RXCOUNT))
    {
        pr_debug("F@TOUCH %s read from device T(%d)/R(%d) greater than settings T(%d)/R(%d)\n",
                 __func__,
                 numberOfColums,
                 numberOfRows,
                 CFG_F54_TXCOUNT,
    ...
    ResultArray = kzalloc(RESULT_SIZE, GFP_KERNEL);
    if(ResultArray)
    {
        memset(ResultArray, 0xff, RESULT_SIZE);
    }
    else
    {
        pr_debug("F@TOUCH : %s alloc ResultArray memory failed\n", __func__);
        goto exit;
    }
...
#if SAVE_TOUCH_RAW_DATA
    TouchRawArray = kzalloc(RESULT_SIZE, GFP_KERNEL);
    if(TouchRawArray)
    {
        memset(TouchRawArray, 0xff, RESULT_SIZE);
    }
    else
    {
        pr_err("F@TOUCH : %s alloc TouchRawArray memory failed\n", __func__);
        goto exit;
    }

    TouchRawdata = filp_open("/data/misc/touch/TouchRawData.bin", O_CREAT | O_RDWR, 0660 );
    if(IS_ERR(TouchRawdata))
    {
        pr_err("F@TOUCH : %s open /data/misc/touch/TouchRawData.bin failed = %ld\n", __func__, PTR_ERR(TouchRawdata));
        goto exit;
    }
#endif
////////////////////////////////////////////////////////////////////////////////////////

    retval = test_sysfs_report_type_store(NULL, NULL, "20", 1);
    if (retval < 0)
    {
        goto exit;
    }
    retval = test_sysfs_do_preparation_store(NULL, NULL, cmd, 1);
    if (retval < 0)
    {
        goto exit;
    }
    retval = test_sysfs_get_report_store(NULL, NULL, cmd, 1);
    if (retval < 0)
    {
        goto exit;
    }
    ...
    retval = test_sysfs_resume_touch_store(NULL, NULL, cmd, 1);
    if (retval < 0)
        goto exit;
////////////////////////////////////////////////////////////////////////////////////////
    report_size = f54->report_size;
    pr_info("F@TOUCH %s report_size(%d)\n", __func__, report_size);
    ...
    {
        pr_info("F@TOUCH %s f54->report_data not found\n", __func__);
        goto exit;
    }

    DataArray = (int*)kmalloc(sizeof(int)*numberOfColums*numberOfRows, GFP_KERNEL);

    item_number = numberOfColums*numberOfRows;
    pr_debug("F@TOUCH %s item_number(%d)\n", __func__, item_number);

    for(i = 0; i < numberOfColums; i++)
    {
        for (j = 0; j < numberOfRows; j++, k+=2)
        {
            temp = buffer[k] | (buffer[k+1] << 8);
            DataArray[i*numberOfRows+j] = ((int)temp);
        }
    }
    ...
    for (i = 0; i < numberOfColums; i++)
    {
        ...
        {
            upper_limit = GISFullRawCapUpperLimit[i][j];
            lower_limit = GISFullRawCapLowerLimit[i][j];
            real_value = DataArray[i*numberOfRows+j];
#if SAVE_TOUCH_RAW_DATA
            raw_pos+= snprintf(&(TouchRawArray[raw_pos]), RESULT_SIZE, "%d,",real_value);
#endif

            if((i == 0) && (j == 0))
            {
                ret += snprintf(&(ResultArray[ret]), RESULT_SIZE, "Data=%d;(C,%d,%d,%d,%d,%d",item_number,i,j, upper_limit, lower_limit, real_value);
            }
            else
            {
                ret += snprintf(&(ResultArray[ret]), RESULT_SIZE, ";(C,%d,%d,%d,%d,%d",i,j, upper_limit, lower_limit, real_value);
            }

            tmp_upper_value = GISFullRawCapUpperLimit[i][j];
            tmp_lower_value = GISFullRawCapLowerLimit[i][j];

            if ((DataArray[i*numberOfRows+j] < tmp_upper_value) &&
                    (DataArray[i*numberOfRows+j] > tmp_lower_value))
            {
                Result = 'P'; /*Pass*/
                ret += snprintf(&(ResultArray[ret]),RESULT_SIZE,",%c)", 'P');
            }
            else
            {
                Result = 'F'; /*Fail*/;
                Touch_TestResult = TEST_FAILED;
                ret += snprintf(&(ResultArray[ret]),RESULT_SIZE, ",%c)", 'F');
            }
            pr_err("F@TOUCH %s [%2d][%2d] (%d) %c\n", __func__,i, j, DataArray[i*numberOfRows+j], Result);
        }
    }

    if(Touch_TestResult != TEST_FAILED)
        Touch_TestResult = TEST_PASS;

    ret += snprintf(&(ResultArray[ret]),RESULT_SIZE,"\n");
    pr_debug("F@TOUCH : %s ret = %d\n", __func__, (int)ret);

    for(check_len = 0; check_len<RESULT_SIZE; check_len++)
    {
        if(ResultArray[check_len] == 0x00)
            break;
    }
    pr_info("F@TOUCH %s check_len = %d",__func__,check_len);
    vfs_write(RawdataFile, ResultArray, strlen(ResultArray), &pos);
    pr_debug("F@TOUCH %s len = %d\n", __func__, len);

#if SAVE_TOUCH_RAW_DATA
    pos=0;
    raw_pos+= snprintf(&(TouchRawArray[raw_pos]), RESULT_SIZE,"\n");
    pr_debug("F@TOUCH : %s raw_pos = %d\n", __func__, (int)raw_pos);
    vfs_write(TouchRawdata, TouchRawArray, strlen(TouchRawArray), &pos);
    //len = TouchRawdata->f_op->write(TouchRawdata, TouchRawArray, RESULT_SIZE, &TouchRawdata->f_pos);
#endif
...
exit:
    ...
    if(!IS_ERR(RawdataFile))
    {
        pr_err("F@TOUCH : %s filp_close(RawdataFile);\n", __func__);
        filp_close(RawdataFile,NULL);
    }
#if SAVE_TOUCH_RAW_DATA
    if(!IS_ERR(TouchRawdata))
    {
        pr_err("F@TOUCH : %s filp_close(TouchRawdata);\n", __func__);
        filp_close(TouchRawdata,NULL);
    }
#endif
    kfree(DataArray);
    kfree(ResultArray);
...
static int synaptics_rmi4_test_init(struct synaptics_rmi4_data *rmi4_data)
{
    ...
    touch_cb.touch_selftest = fullRawCap;
