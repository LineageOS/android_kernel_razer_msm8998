...
static void synaptics_rmi4_power_on(struct synaptics_rmi4_data *rmi4_data)
{
    int retval;
    const struct synaptics_dsx_board_data *bdata =
            rmi4_data->hw_if->board_data;
...
static void synaptics_rmi4_power_off(struct synaptics_rmi4_data *rmi4_data)
{
    int retval;
    const struct synaptics_dsx_board_data *bdata =
            rmi4_data->hw_if->board_data;
...
static int synaptics_rmi4_suspend(struct device *dev)
{
    ...
    if (!rmi4_data->suspend)
    {
        synaptics_rmi4_irq_enable(rmi4_data, false, false);
        synaptics_rmi4_sleep_enable(rmi4_data, true);
        synaptics_rmi4_power_off(rmi4_data);
    }
...
static int synaptics_rmi4_resume(struct device *dev)
{
    ...
    synaptics_rmi4_power_on(rmi4_data);
