...
static char *my_proc_name = "blog";
static unsigned int my_proc_addr = FIH_BLOG_BASE;
//static unsigned int my_proc_addr = 0x9FF38000;
static unsigned int my_proc_size = FIH_BLOG_SIZE;
//static unsigned int my_proc_size = 0x8000;
